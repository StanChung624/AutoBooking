...
# Scripts collections
# -----------------------------------------------------------------------------#
from .script_Sunrise import Sunrise 
...
from .script_Paradise import Paradise
class Paradise(Paradise):
    """
        饗食天堂
                tested on chrome v.100 / at 2022.05.25
    Auto run with set scripts.
...
from .script_SyaBuYo import SyaBuYo
class SyaBuYo(SyaBuYo):
    """
        涮乃葉
                tested on chrome v.100 / at 2022.05.25
    Auto run with set scripts.
...
from .script_MoMoParadise import MoMoParadise
class MoMoParadise(MoMoParadise):
    """
        Mo-Mo Paradise
                tested on chrome v.100 / at 2022.05.25
    Auto run with set scripts.
